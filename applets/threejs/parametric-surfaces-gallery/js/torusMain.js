...
import { torusSurface as parametricSurface } from './parametricSurfaces.js';
...
gui.add(options, 'r', 0.01, 3, 0.01).onChange(() => {
    geometry.dispose();
    geometry = new ParametricGeometry((u, v, target) => parametricSurface(u, v, target, options.r, options.R), 64, 64);
    geometry.rotateX(-Math.PI / 3);
    geometry.scale(0.35, 0.35, 0.35);
