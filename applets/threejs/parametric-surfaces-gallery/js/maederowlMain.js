...
import { maederowlSurface as parametricSurface } from './parametricSurfaces.js';
...
let geometry = new ParametricGeometry((u, v, target) => parametricSurface(u, v, target), meshRes.x, meshRes.y);
