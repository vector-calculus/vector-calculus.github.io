...
// Geometry
let geometry = new ParametricGeometry((u, v, target) => parametricSurface(u, v, target, options.a), 100, 80);
...
gui.add(options, 'a', 8, 18, 0.01).onChange(() => {
    geometry.dispose();
    geometry = new ParametricGeometry((u, v, target) => parametricSurface(u, v, target, options.a), 100, 60);
    geometry.rotateX(-Math.PI / 2.2);
    geometry.rotateY(Math.PI / 8);
