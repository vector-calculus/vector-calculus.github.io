...
import { juliaheartSurface as parametricSurface } from './parametricSurfaces.js';
...
// Geometry
const meshRes = { x: 80, y: 80 };
const geoScale = { x: 0.22, y: 0.22, z: 0.22 };
...
gui.add(options, 'uComponent', 0, 6.2631, 0.0001).name('u').onChange(() => {
    geometry.dispose();
